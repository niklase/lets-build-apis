...
public class OpenApiDocumentValidator {

    private static JsonSchemaValidator validator = new JsonSchemaValidator();

    private static final String OPENAPI_SCHEMA = """
            {
    ...
    private static JsonValue schema = JsonValueFactory.create(OPENAPI_SCHEMA);

    public JsonObject validate(JsonValue openApiDocument) {
            return validator.validate(openApiDocument, schema, OutputStructure.DETAILED);
    }
